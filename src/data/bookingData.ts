...
export const SERVICIOS: Record<string, Servicio[]> = {
  ...
  "Manicure": [
    ...
    { nombre: "Retoque Recubrimiento Poly/Acrílico",calendarId: "g7a3uGcoBdAdrffowsY1", duracion: 120, precio: "$100.000", profesionales: NAILS },
  ...
  "Pedicure": [
    ...
    { nombre: "Pies Evolution",                 calendarId: "tKn5Hy3A7pKqg7nhVpgC", duracion: 60, precio: "$40.000", profesionales: NAILS },
    { nombre: "Tradicional Pies",               calendarId: "XbxF4HF4VH3KNB16sNBU", duracion: 60, precio: "$45.000", profesionales: NAILS },
    { nombre: "Retiro Semipermanente Pies",     calendarId: "FJDuHD0L2DqBLPUeYsqM", duracion: 30, precio: "$20.000", profesionales: NAILS },
